...
class MultihrefMetadata extends Base
{
    ...
    {
        $resolver = new \Pimcore\Bundle\DataHubBundle\GraphQL\QueryFieldConfigGenerator\Helper\MultihrefMetadata($this->getGraphQlService(), $attribute, $fieldDefinition, $class);
