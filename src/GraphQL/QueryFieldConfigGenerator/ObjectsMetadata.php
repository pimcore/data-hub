...
class ObjectsMetadata extends Base
{
    ...
    {
        $resolver = new \Pimcore\Bundle\DataHubBundle\GraphQL\QueryFieldConfigGenerator\Helper\ObjectsMetadata($this->getGraphQlService(), $attribute, $fieldDefinition, $class);
