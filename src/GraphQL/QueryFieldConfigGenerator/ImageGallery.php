...
class ImageGallery extends Base
{
    ...
    {
        $resolver = new \Pimcore\Bundle\DataHubBundle\GraphQL\QueryFieldConfigGenerator\Helper\ImageGallery($this->getGraphQlService(), $attribute, $fieldDefinition, $class);
