...
class Href extends Base
{
    ...
    {
        $resolver = new \Pimcore\Bundle\DataHubBundle\GraphQL\DataObjectQueryFieldConfigGenerator\Helper\Href($this->getGraphQlService(), $attribute, $fieldDefinition, $class);
