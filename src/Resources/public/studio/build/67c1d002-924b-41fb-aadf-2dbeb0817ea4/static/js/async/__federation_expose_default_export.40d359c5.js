/*! For license information please see __federation_expose_default_export.40d359c5.js.LICENSE.txt */
"use strict";(self["chunk_pimcore_datahub_bundle "]=self["chunk_pimcore_datahub_bundle "]||[]).push([["525"],{7673(e,i,l){l.r(i),l.d(i,{BaseDetailView:()=>d.Wc,ColumnLocaleControl:()=>W,stringifyYaml:()=>C,ADVANCED_COLUMN_KEY:()=>P,useCompactLayout:()=>$,advancedToSchemaColumn:()=>L,ADVANCED_COLUMN_TYPE:()=>z,BaseColumnEditor:()=>Z,CompactLayoutProvider:()=>k,ColumnEditorItemBody:()=>X,DynamicTypeDataHubAdapterAbstract:()=>r.E,DynamicTypeDataHubAdapterRegistry:()=>s.f,DataHubLogTab:()=>eo,PermissionsTab:()=>a.K,ConfigToolbar:()=>d.MM,advancedFromSchemaColumn:()=>A,GeneralTab:()=>t.a,ColumnConfigModal:()=>D,ConfigSummary:()=>b,parseYaml:()=>S,trackConfigError:()=>d.Mv,useAddColumnGroups:()=>E,StatusTag:()=>x,ColumnPreview:()=>_,ConfigContainer:()=>n.y,isValidYaml:()=>w,bundleServiceIds:()=>o.s,useDetailView:()=>d.iO,MigrationModal:()=>I,ColumnPipelineForm:()=>R});var n=l(6100),t=l(970),a=l(6427),o=l(17),r=l(5667),s=l(8576),d=l(2379),c=l(4848),u=l(2812),p=l.n(u),m=l(4781),g=l(2696);let h={added:"green",changed:"gold",removed:"red",moved:"geekblue"},x=e=>{let{status:i}=e,{t:l}=(0,m.useTranslation)();return(0,c.jsx)(g.Tag,{color:h[i],"data-review-mark":"",style:{marginInlineEnd:0},children:l(`data-hub.review.status.${i}`)})},f=(0,m.createStyles)(e=>{let{token:i,css:l}=e;return{summary:l`
    min-width: 0;
  `,head:l`
    display: flex;
