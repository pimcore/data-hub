"use strict";
(self["webpackChunkpimcore_datahub_bundle"] = self["webpackChunkpimcore_datahub_bundle"] || []).push([["js_src_components_base-detail-view_index_ts-js_src_modules_config_config-container_tsx-js_src-3b5091"], {
...
function ConfigToolbar(param) {
    let { configName, isWriteable, isLoading, isSaving, isDirty, onSave, onRefresh, onDelete, additionalButtons = [] } = param;
    _s();
...
_s(ConfigToolbar, "zlIdU9EjM2llFt74AbE2KsUJXyM=", false, function() {
    return [
...
/* import */ var _pimcore_studio_ui_bundle_modules_app__rspack_import_3 = __webpack_require__("webpack/container/remote/@pimcore/studio-ui-bundle/modules/app");
/* import */ var _pimcore_studio_ui_bundle_modules_app__rspack_import_3_default = /*#__PURE__*/__webpack_require__.n(_pimcore_studio_ui_bundle_modules_app__rspack_import_3);
...
function useDetailView(param) {
    ...
    (0,react__rspack_import_0.useEffect)(()=>{
        if (isLoading || (0,lodash__rspack_import_4.isNil)(configData)) return;
    ...
    const handleSave = ()=>{
        ...
        form.validateFields().then(async (values)=>{
            ...
            try {
                ...
                if (!(0,lodash__rspack_import_4.isNil)(response === null || response === void 0 ? void 0 : response.modificationDate)) {
                ...
                if ((0,_pimcore_studio_ui_bundle_modules_app__rspack_import_3.isApiErrorData)(error)) {
                    (0,_pimcore_studio_ui_bundle_modules_app__rspack_import_3.trackError)(new _pimcore_studio_ui_bundle_modules_app__rspack_import_3.ApiError(error));
                }
            } finally{
