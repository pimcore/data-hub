"use strict";
(self["webpackChunkpimcore_datahub_bundle"] = self["webpackChunkpimcore_datahub_bundle"] || []).push([["__federation_expose_plugins"], {
...
const filterTreeNodesRecursive = (nodes, searchValue)=>{
    ...
    return nodes.reduce((acc, node)=>{
        ...
        const filteredChildren = !(0,lodash__rspack_import_6.isNil)(node.children) && Array.isArray(node.children) ? filterTreeNodesRecursive(node.children, searchValue) : [];
        // Include node if:
...
const collectAllKeys = (nodes)=>{
    return (0,lodash__rspack_import_6.flatMapDeep)(nodes, (node)=>[
            ...(0,lodash__rspack_import_6.isNil)(node.key) ? [] : [
                String(node.key)
            ],
            ...!(0,lodash__rspack_import_6.isNil)(node.children) && Array.isArray(node.children) ? collectAllKeys(node.children) : []
        ]);
};
const useClassAttributesTree = (param)=>{
    ...
    const classAttributesTree = (0,react__rspack_import_1.useMemo)(()=>{
        const buildDataObjectColumns = ()=>{
            ...
            return (tree === null || tree === void 0 ? void 0 : tree.children) ?? [];
        };
    ...
    const getFieldDefinitions = (0,react__rspack_import_1.useCallback)(()=>{
        ...
        if ((0,lodash__rspack_import_6.isNil)(objectColumnsNode) || (0,lodash__rspack_import_6.isNil)(objectColumnsNode.children)) return [];
        ...
        return collectFieldDefinitions(objectColumnsNode.children);
    }, [
        classAttributesTree
    ]);
    return {
...
_s(useClassAttributesTree, "zfk50okJtAbqZ6dsB9KQbkKirgc=", false, function() {
    return [
