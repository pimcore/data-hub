...
pimcore.registerNS("pimcore.plugin.datahub.operator.concatenator");

pimcore.plugin.datahub.operator.concatenator = Class.create(pimcore.plugin.datahub.Abstract, {
