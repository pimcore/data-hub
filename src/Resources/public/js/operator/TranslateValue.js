...
pimcore.registerNS("pimcore.plugin.datahub.operator.translatevalue");

pimcore.plugin.datahub.operator.translatevalue = Class.create(pimcore.plugin.datahub.Abstract, {
