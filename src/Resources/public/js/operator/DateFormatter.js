...
pimcore.registerNS("pimcore.plugin.datahub.operator.dateformatter");

pimcore.plugin.datahub.operator.dateformatter = Class.create(pimcore.plugin.datahub.Abstract, {
