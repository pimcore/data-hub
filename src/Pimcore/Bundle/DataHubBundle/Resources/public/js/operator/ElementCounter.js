...
pimcore.registerNS("pimcore.plugin.datahub.operator.elementcounter");

pimcore.plugin.datahub.operator.elementcounter = Class.create(pimcore.plugin.datahub.Abstract, {
