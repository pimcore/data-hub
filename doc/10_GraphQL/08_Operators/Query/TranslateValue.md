...
Similar to Pimcore's `Translate Value` grid configuration operator. For a detailed example see [Website Translations](../../04_Query/11_Query_Samples/27_Sample_Translate_Values.md).
