      ...
      items: [
       {
        ...
        editables: {
         input: [{ _tagName: "headline", text: "HEY, I AM A SUBHEADLINE" }]
         wysiwyg: [{ _tagName: "lead", text: "The lead text" }]
        }
       }
       {
        type: "wysiwyg-with-images"
           ...
           items: [
            {
             ...
             editables: {
              image: [
               { _tagName: "image", alt: "alt text for image 1", id: 18 }
              ]
             }
            }
            {
             ...
             editables: {
              image: [
               { _tagName: "image", alt: "alt text for image 2", id: 22 }
              ]
             }
            }
           ]
       ...
       {
        type: "image"
        editables: { image: [{ _tagName: "image", alt: "alt text", id: 67 }] }
       }
      ]
     }
    ]
